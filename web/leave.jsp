<%-- 
    Document   : leave
    Created on : 17 Dec, 2019, 10:29:53 AM
    Author     : rumit
--%>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="leave.jsp"><i class="fa fa-edit"></i> Leave </a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                         ...
                         <li>
                        <a href="logout.jsp"><i class="glyphicon glyphicon-off"></i> Logout </a>
                    </li>
                        </ul>
                    </li>
